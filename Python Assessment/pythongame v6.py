...
class HealthPotion(AnimatedObject):
    ...
    def __init__(self):
        ...
        # and takes on all its variables
        super().__init__(f"{MAIN_FILE_PATH}Assets/Collectables/heart", POWERUP_SIZE, 6, POWERUP_RATE)
...
class SpeedPowerup(AnimatedObject):
    ...
    def __init__(self):
        ...
        # The hearts class becomes an animated object
        # and takes on all its variables
        super().__init__(f"{MAIN_FILE_PATH}Assets/Collectables/speed", POWERUP_SIZE, 12,POWERUP_RATE) #Make heart heal size powerup size
...
#class Coins(AnimatedObject):
    ...
    #def __init__(self):
        ...
        # The hearts class becomes an animated object
        # and takes on all its variables
        #super().__init__(f"{MAIN_FILE_PATH}Assets/Collectables/coin", POWERUP_SIZE, 6,POWERUP_RATE)
...
#class Gem(AnimatedObject):
    ...
    #def __init__(self):
        ...
        # The hearts class becomes an animated object
        # and takes on all its variables
        #super().__init__(f"{MAIN_FILE_PATH}Assets/Collectables/gem", POWERUP_SIZE, 6,POWERUP_RATE)
...
class Game(arcade.View):
    ...
    def setup(self):
        ...
        for my_powerups in self.powerups_layer:
            ...
            if powerup_type == "health":
                ...
                powerup = arcade.Sprite(f"{MAIN_FILE_PATH}Assets/Collectables/Kunai.png",POWERUP_SIZE/2)
        ...
        self.physics_engine = arcade.PhysicsEnginePlatformer(
                ...
                ladders = self.map[LADDER_LAYER], walls = [self.map[PLATFORM_LAYER],self.map[FOREGROUND_LAYER]]
                )
    ...
    def on_draw(self):
        ...
        # This draws the number of knives on a specific co-ordinate on the screen at which
        # it will stay for the rest of the game
    ...
    def on_update(self, delta_time):
        ...
        for enemy in self.map.get_sprite_list(ENEMY_LAYER):
            ...
            if enemy.health <= 0:
                knife= arcade.Sprite(f"{MAIN_FILE_PATH}Assets/Collectables/Kunai.png",POWERUP_SIZE/2)
                knife.type = "knife"
        ...
        if arcade.check_for_collision_with_list(
            ...
            self.map[FOREGROUND_LAYER].clear()
